...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, PropertyChangeListener{
    ...
    private FileContentProvider KM_DB = new FileContentProvider();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2 = (Button) findViewById(R.id.btnIntent2);
...
//                intent.setClass(MainActivity.this, LoginUse.class);
//                startActivity(intent);

            case R.id.btnIntent2:
                Intent in = new Intent();
                in.setClass(MainActivity.this, LoginUser.class);
                startActivity(in);
        }
    }
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if (switchPowerService == null) {
                try {
                    ...
                    Toast.makeText(MainActivity.this, R.string.registering_demo_device, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity.this, R.string.create_demo_failed, Toast.LENGTH_SHORT).show();
                    return;
                }
            }
